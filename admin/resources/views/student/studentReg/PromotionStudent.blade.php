...
@section('content')
    <div id="layoutSidenav_content">
        ...
        <div id="" class="container mt-4">
            ...
            <form action="{{route('students_promotionStore',$editData->student_id)}}" id="myForm" method="POST">@csrf
                ...
                <button class="btn btn-blue-grey btn-sm" type="submit" form="myForm" value="Submit">{{(@$editData)?'Promote':'Submit'}}</button>
            </form>
