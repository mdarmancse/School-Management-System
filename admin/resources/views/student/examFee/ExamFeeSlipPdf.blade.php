...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-12 text-center mt">
            <h5 style="font-weight: bold;padding: -25px;"> Exam Fee</h5>
        ...
        <div class="col-md-12">
            @php
                 ...
                 $examFee=
                 \App\Model\FeeAmountModel::where('fee_category_id','2')->where('class_id',$details->class_id)->first();
            ...
            <table border="1" width="100%">
                ...
                <tr>
                    <td style="width: 50%">Total Fee of {{$examType}}:</td>
                    <td>{{$finalFee}} Tk</td>
                </tr>
