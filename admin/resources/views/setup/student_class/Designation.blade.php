    ...
    <div id="layoutSidenav_content">
        ...
        <div class="container-fluid">
            <ol class="breadcrumb mt-4">
                <li class="breadcrumb-item active">Desgnation</li>
            </ol>
            <div class="row">
                <div id="mainDiv" class="col-md-12 p-5 d-none">
                    <button id="addNew" type="button" class=" btn btn-sm btn-danger"><i class="fas fa-plus"></i> Designation</button>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body mx-3">
                            ...
                            <div id="EditForm" class="d-none">
                                ...
                                <input type="text" id="designationId" class="form-control validate" placeholder="Designation">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body mx-3">
                            ...
                            <div id="addForm">
                                ...
                                <input type="text" id="adddesignationId" class="form-control validate" placeholder="Designation">
            ...
            @section('script')
                ...
                <script type="text/javascript">
                    ...
                    getData();
                    function getData() {
                        axios.get('/setups/designation/getData')
                    ...
                    function deleteData(deleteId) {
                        ...
                        axios.post('/setups/designation/deleteData', {
                            id: deleteId
                        })
                    ...
                    function getUpdateDetails(detailsId) {
                        ...
                        axios.post('/setups/designation/getDetails', {
                            id: detailsId
                        })
                            .then(function(response) {
                                ...
                                if (response.status == 200) {
                                    ...
                                    $('#designationId').val(jsonData[0].designation);
                    ...
                    $('#EditConfirmBtn').click(function() {
                        ...
                        updateDetails(id,designation);

                    });

                    function updateDetails(id, designation) {
                        if (designation.length == 0) {
                            ...
                            var url = '/setups/designation/updateData';
                            var detailsData = {
                                id: id,
                    ...
                    $('#addConfirmBtn').click(function() {
                        ...
                        var designation = $('#adddesignationId').val();

                        insertDetails(designation);

                    });

                    function insertDetails(designation) {
                        if (designation.length == 0) {
                            toastr.error('Designation is empty');
                            ...
                            var url = '/setups/designation/insertData';
                            var detailsData = {
