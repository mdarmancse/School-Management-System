        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div id="mainDiv" class="col-md-12 p-5 d-none">
                    <button id="addNew" type="button" class=" btn btn-sm btn-danger">Add Fee Category</button>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body mx-3">
                            ...
                            <div id="addForm">
                                ...
                                <input type="text" id="addfeeCatId" class="form-control validate" placeholder="Fee Category">
            ...
            @section('script')
                ...
                <script type="text/javascript">
                    ...
                    getData();
                    function getData() {
                        axios.get('/setups/feeCat/getData')
                    ...
                    function deleteData(deleteId) {
                        ...
                        axios.post('/setups/feeCat/deleteData', {
                            id: deleteId
                        })
                    ...
                    function getUpdateDetails(detailsId) {
                        ...
                        axios.post('/setups/feeCat/getDetails', {
                            id: detailsId
                        })
                            .then(function(response) {
                                ...
                                if (response.status == 200) {
                                    ...
                                    $('#feeCatId').val(jsonData[0].feeCat);
                    ...
                    $('#EditConfirmBtn').click(function() {
                        ...
                        updateDetails(id,feeCat);

                    });

                    function updateDetails(id, feeCat) {
                        if (feeCat.length == 0) {
                            ...
                            var url = '/setups/feeCat/updateData';
                            var detailsData = {
                                id: id,
                                feeCat:feeCat
                            };
                    ...
                    $('#addConfirmBtn').click(function() {
                        ...
                        insertDetails(feeCat);

                    });

                    function insertDetails(feeCat) {
                        if (feeCat.length == 0) {
                            toastr.error('Fee category is empty');
                            ...
                            var url = '/setups/feeCat/insertData';
                            var detailsData = {
