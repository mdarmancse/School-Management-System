        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div id="mainDiv" class="col-md-12 p-5 d-none">
                    <button id="addNew" type="button" class=" btn btn-sm btn-danger">Add Shift</button>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body mx-3">
                            ...
                            <div id="EditForm" class="d-none">
                                ...
                                <input type="text" id="shiftId" class="form-control validate" placeholder="Shift">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body mx-3">
                            ...
                            <div id="addForm">
                                ...
                                <input type="text" id="addshiftId" class="form-control validate" placeholder="Shift">
            ...
            @section('script')
                ...
                <script type="text/javascript">
                    ...
                    getData();
                    function getData() {
                        axios.get('/setups/shift/getData')
                    ...
                    function deleteData(deleteId) {
                        ...
                        axios.post('/setups/shift/deleteData', {
                            id: deleteId
                        })
                    ...
                    function getUpdateDetails(detailsId) {
                        ...
                        axios.post('/setups/shift/getDetails', {
                            id: detailsId
                        })
                            .then(function(response) {
                    ...
                    $('#EditConfirmBtn').click(function() {
                        ...
                        updateDetails(id,shift);

                    });

                    function updateDetails(id, shift) {
                        if (shift.length == 0) {
                            toastr.error('Shift is empty');

                        } else {

                            $('#EditConfirmBtn').html("<div class='spinner-border spinner-border-sm' role='status'></div>");
                            var url = '/setups/shift/updateData';
                            var detailsData = {
                                id: id,
                                shift:shift
                            };
                    ...
                    $('#addConfirmBtn').click(function() {
                        ...
                        var shift = $('#addshiftId').val();

                        insertDetails(shift);

                    });

                    function insertDetails(shift) {
                        if (shift.length == 0) {
                            toastr.error('Shift is empty');
                            ...
                            var url = '/setups/shift/insertData';
                            var detailsData = {
