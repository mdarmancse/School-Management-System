                    ...
                    <div id="mainDiv" class="col-md-12">
                        ...
                        <table id="DataTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tr>
                                ...
                                <th class="th-sm">Salary Increment</th>
                            ...
                            @foreach($allData as $key=>$allData)
                                <tr>
                                    ...
                                    <th class="th-sm"><a href="{{route('employee_salary_increment',$allData->id)}}" ><i class="fas fa-plus"></i></a></th>
                                    {{--                                        <th class="th-sm"><a href="{{route('student_promotion',$allData->student_id)}}" ><i class="fa fa-arrow-circle-up"></i></a></th>--}}
                                    <th class="th-sm"><a  href="{{route('employee_salary_details',$allData->id)}}" ><i class="fas fa-eye"></i></a></th>
